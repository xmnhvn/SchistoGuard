...
export function AppSidebar({ currentView, onNavigate, onLogout, user, onToggleDrawer, drawerOpen }: NavigationProps & { onLogout?: () => void; onToggleDrawer?: () => void; drawerOpen?: boolean }) {
  ...
  return (
    <aside
      style={{
        position: "fixed",
        top: expanded ? (isPhone ? 0 : (vw <= 1450 ? 64 : (vw < 1700 ? 72 : 80))) : (isPhone ? 0 : (vw <= 1450 ? 64 : (vw < 1700 ? 72 : 80))),
        left: 0,
        bottom: 0,
  ...
  return (
    <header
      style={{
        ...
        height: vw <= 1450 ? 64 : (vw < 1700 ? 72 : 80),
        position: "fixed",
        top: 0,
        left: 0,
        right: 0,
        ...
        {isPhone ? (
          ...
          <>
            <button
              ...
              style={{
                ...
                width: 60, height: vw < 1600 ? 64 : 80, flexShrink: 0,
          ...
          <>
            <button
              ...
              style={{
                background: "none", border: "none", cursor: "pointer",
                width: 70, height: vw < 1700 ? 72 : 80, flexShrink: 0,
                display: "flex", alignItems: "center", justifyContent: "center",
                borderRadius: 0,
              }}
            >
