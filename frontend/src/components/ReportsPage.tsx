        ...
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-1 flex flex-col h-80">
              ...
              <DialogContent className="max-w-md w-1/2">
                ...
                <form className="space-y-6" onSubmit={handleCreateReport}>
                  ...
                  <div className="flex justify-center gap-3 pt-6">
                    <DialogClose asChild>
                      <button type="button" className="px-8 py-2 rounded border bg-white-100 hover:bg-gray-300" disabled={creating}>Cancel</button>
                    </DialogClose>
                    <button 
                      type="submit" 
                      className="px-8 py-2 rounded bg-schistoguard-teal text-white hover:bg-schistoguard-teal/90 font-semibold flex items-center gap-2"
                      disabled={creating}
                    >
                      {creating ? (
                        <>
            ...
            <div className="flex-1 overflow-y-auto space-y-3">
              {loading ? (
                <div className="text-center text-gray-500 py-8 flex items-center justify-center h-60">
                  ...
                  <div key={report.id} className="flex items-center justify-between p-6 border rounded-lg bg-white">
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-500 mb-1">
                        Total Sites: {report.summary.totalSites} &nbsp;|&nbsp; Alerts: {report.summary.alertsGenerated}
                      </div>
                      <div className="text-xs text-gray-500 mb-2">
                        Avg Turbidity: {report.summary.avgTurbidity} NTU &nbsp;|&nbsp; 
                        Avg Temp: {report.summary.avgTemperature || 0}°C &nbsp;|&nbsp; 
                        Avg pH: {report.summary.avgPh || 0}
                      </div>
                      <div className="mt-2">
