      ...
      `}</style>
        ...
        <div style={{
          ...
          <div style={{
            ...
            >
              <Download size={isNarrowDesktop ? 14 : 15} />
              Export
            </button>
          </div>
        </div>
        ...
        <div style={{
          ...
          gap: isMobile ? 12 : (isNarrowDesktop ? 16 : 20),
          marginBottom: 24,
          ...
          {[
            ...
            <div key={card.label} style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: isNarrowDesktop ? 8 : 12 }}>
                <span style={{ fontSize: isNarrowDesktop ? 11.5 : 13, fontWeight: 500, color: "#8E8B8B", fontFamily: POPPINS, letterSpacing: 0 }}>{card.label}</span>
                <div style={{
